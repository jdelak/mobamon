...
<shader>
	...
	<node name="sceneRefraction" type="scene_refract" param="800.0 25.0 0.1" />
	<link from="viewBump" to="sceneRefraction" />
	
	<node name="sceneNoSize" type="float2_constant" param="1.5 1.5" />
	...
	<link from="scene0.rgb" to="scene.A" />
	<link from="color.rgb" to="scene.B" />
	
	<node name="fresnel" type="fresnel" param=".1 1 1" />
