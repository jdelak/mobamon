...
<shader>
	...
	<node name="diffuse1" type="art_circle" >
		<parameter name="Thickness" value="0.005" />
		<parameter name="BlurThickness" value="0.002" />
		<parameter name="Alpha" value="0.6" />
	</node>
	<node name="diffuse2" type="art_circle" >
		<parameter name="Thickness" value="0.02" />
		<parameter name="BlurThickness" value="0.005" />
		<parameter name="Alpha" value="0.2" />
		<parameter name="Offset" value="0.995" />
	</node>
	<node name="diffuse3" type="art_round_gradient" >
		<parameter name="Alpha" value="0.15" />
	</node>
	<node name="diffuse4" type="art_circle_spikes" >
		<parameter name="Alpha" value="0.1" />
		<parameter name="Lenght" value="0.5" />
		<parameter name="Offset" value="1.25" />
		<parameter name="Size" value="0.03" />
		<parameter name="Spacing" value="0.1" />
	</node>
	...
	<link from="diffuseAdd2" to="diffuseOut.B" />
