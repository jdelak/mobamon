...
<shader>
	...
	<node name="fresnelParams" type="float3_material_parameter" param="vReflectFresnel" />
	...
	<node name="enviroColor" type="float3_material_parameter" param="vReflectColor" />
	...
	<link from="specular.rgb" to="specularScale.A" />
