...
<shader>
	...
	<node name="offsetLength" type="float_material_parameter" param="fOffset" />
	
	<node name="offset0" type="multiply" />
	<link from="sourceNormal" to="offset0.A" />
	<link from="offsetLength" to="offset0.B" />
	...
	<link from="diffuse" to="finalColor.A" />
	<link from="color" to="finalColor.B" />
	
	<node name="Material" type="material" />
	<link from="finalColor.rgb" to="Material.Emissive" />
	<link from="finalColor.a" to="Material.Opacity" />
</shader>