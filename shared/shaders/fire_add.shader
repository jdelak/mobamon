...
<shader>
	...
	<node name="fresnelParams" type="float3_constant" param="-1.5 4.0 1.2" />
	...
	<link from="fresnel" to="enviroScale.B" />
	
	<node name="vertColor" type="vertex_color"/>
	<node name="mult" type="multiply" />
	<node name="panner" type="panner" param="1 0" />
	...
	<link from="diffuse.a" to="Material.Light" />
