...
function altInfoBuildingRegister(object)
	...
	levelBar:RegisterWatchLua('AltInfoBuilding', function(widget, trigger) widget:SetWidthF(math.min(trigger.lifetimepercent * lifetimeMaxWidth, lifetimeMaxWidth)) end, true, nil, 'lifetimepercent')
