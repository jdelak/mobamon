...
function altInfoCreepRegister(object)
	...
	levelBar:RegisterWatchLua('AltInfoCreep', function(widget, trigger) widget:SetWidthF(math.min(trigger.lifetimepercent * lifetimeMaxWidth, lifetimeMaxWidth)) end, true, nil, 'lifetimepercent')
