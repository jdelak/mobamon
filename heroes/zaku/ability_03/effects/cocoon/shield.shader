...
<shader>
	...
	<node name="vertPan" type="panner" param="-.2 -.2"/>
	<link from="vertPan" to="texcoord1"/>	
	
	<node name="vertPan2" type="panner" param="0 0"/>
	...
	<node name="vertPan4" type="panner" param="0 0"/>
	...
	<node name="fresnel" type="fresnel" param="10 .2 3"/>	
