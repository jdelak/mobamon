...
<shader>
	...
	<node name="vertPan" type="panner" param="0.0 1.4"/>
	<link from="vertPan" to="texcoord1"/>	
	
	<node name="vertPan2" type="panner" param="0.1 0.0"/>
	<link from="vertPan2" to="texcoord0"/>	


	
	<node name="vertPan3" type="panner" param="0.0 1.4"/>
	<link from="vertPan3" to="texcoord3"/>	
	
	<node name="vertPan4" type="panner" param="0.1 0.0"/>
	...
	<node name="fresnel" type="fresnel" param="0.2 11 3"/>	
