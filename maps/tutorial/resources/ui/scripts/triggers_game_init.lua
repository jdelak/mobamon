...
trigger_gamePanelInfo.backpackVis					= Cvar.GetCvar('_backpackVis'):GetBoolean()
...
trigger_gamePanelInfo.boss1ExpandedPinned			= false
trigger_gamePanelInfo.boss2Expanded					= false
trigger_gamePanelInfo.boss2ExpandedPinned			= false
...
trigger_gamePanelInfo.mapWidgetVis_arcadeText		= false
