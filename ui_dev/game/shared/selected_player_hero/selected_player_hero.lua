...
local function selectedPlayerHeroRegister(object)
	...
	object:GetWidget('selectedPlayerHeroArmor'):RegisterWatchLua('SelectedUnit', function(widget, trigger)
		widget:SetText(libNumber.round(trigger.armor,1))
	end, false, nil, 'armor')
	
	object:GetWidget('selectedPlayerHeroMagicArmor'):RegisterWatchLua('SelectedUnit', function(widget, trigger)
		widget:SetText(libNumber.round(trigger.magicArmor,1))
	end, false, nil, 'magicArmor')
