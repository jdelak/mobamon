...
function RegisterKillerWatchers()
	--[[
...
function RegisterPieWatchers() 
	pies.DamageTypePie.container:RegisterWatchLua('DeathRecap', function(widget, trigger)
		...
		pies.DamageTypePie.Percents[1]:SetText(math.floor(phys / total * 100)..'%')
		pies.DamageTypePie.Percents[2]:SetText(math.floor(abil / total * 100)..'%')
	...
	pies.DamageHeroPie.container:RegisterWatchLua('DeathRecap', function(widget, trigger)
		...
		for i=2,6 do
			pies.DamageHeroPie.Pies[i]:SetValue(damage[i] / total)
		end
		
		for i=1,6 do
			pies.DamageHeroPie.Percents[i]:SetText(math.floor(damage[i] / total * 100)..'%')
		end
	...
	--[[	
	pies.DamageHeroPie.Labels[1]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount1 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetText(trigger.teamDamageHero1)
		end
	end, true, nil, "teamDamageHero1", "teamDamageAmount1")

	pies.DamageHeroPie.Labels[2]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount2 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetText(trigger.teamDamageHero2)
		end
	end, true, nil, "teamDamageHero2", "teamDamageAmount2")

	pies.DamageHeroPie.Labels[3]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount3 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetText(trigger.teamDamageHero3)
		end
	end, true, nil, "teamDamageHero3", "teamDamageAmount3")

	pies.DamageHeroPie.Labels[4]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount4 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetText(trigger.teamDamageHero4)
		end
	end, true, nil, "teamDamageHero4", "teamDamageAmount4")
	pies.DamageHeroPie.Labels[5]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount5 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetText(trigger.teamDamageHero5)
		end
	end, true, nil, "teamDamageHero5", "teamDamageAmount5")
	--]]
	...
	--[[
	pies.DamageHeroPie.Icons[1]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount1 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetTexture(trigger.teamDamageIcon1)
		end
	end, true, nil, "teamDamageIcon1", "teamDamageAmount1")

	pies.DamageHeroPie.Icons[2]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount2 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetTexture(trigger.teamDamageIcon2)
		end
	end, true, nil, "teamDamageIcon2", "teamDamageAmount2")

	pies.DamageHeroPie.Icons[3]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount3 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetTexture(trigger.teamDamageIcon3)
		end
	end, true, nil, "teamDamageIcon3", "teamDamageAmount3")

	pies.DamageHeroPie.Icons[4]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount4 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetTexture(trigger.teamDamageIcon4)
		end
	end, true, nil, "teamDamageIcon4", "teamDamageAmount4")

	pies.DamageHeroPie.Icons[5]:RegisterWatchLua('DeathRecap', function(widget, trigger)
		if (trigger.teamDamageAmount5 == 0) then
			widget:SetVisible(false)
		else
			widget:SetVisible(true)
			widget:SetTexture(trigger.teamDamageIcon5)
		end
	end, true, nil, "teamDamageIcon5", "teamDamageAmount5")
...
function deathRecapRegister(object)
	...
	showButton:RegisterWatchLua('deathRecapShowButtonVis', function(widget, groupTrigger)
		...
		widget:SetVisible((not triggerHero.isActive) and (triggerScore.deaths > 0) and (false)) -- RMM disabled for pax
		if (triggerHero.isActive) and (object:GetWidget('deathRecapContainer'):IsVisible()) then
			deathRecapContainer:FadeOut(250)
			-- ToggleDeathRecap()			
		end
	end)
	...
	showButton:SetCallback('onclick', function(widget)
		if deathRecapContainer:IsVisible() then
			deathRecapContainer:FadeOut(250)
		else
			deathRecapContainer:FadeIn(250)
		end
	end)
	...
	-- showButton:RegisterWatchLua('ShopActive', function(widget, trigger)
		-- if trigger.isActive then
			-- widget:SlideX(libGeneral.HtoP(51), styles_uiSpaceShiftTime)
		-- else
