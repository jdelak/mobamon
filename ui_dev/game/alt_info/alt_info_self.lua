...
object:GetWidget('AltInfoSelfTutExplainArmorBorder'):RegisterWatchLua('altInfoSelfTabExplain', function(widget, trigger)
	widget:SetVisible(trigger.armorFocus)
end, false, nil, 'armorFocus')


object:GetWidget('AltInfoSelfTutExplainMagicArmorBorder'):RegisterWatchLua('altInfoSelfTabExplain', function(widget, trigger)
	widget:SetVisible(trigger.magicArmorFocus)
end, false, nil, 'magicArmorFocus')
...
object:GetWidget('AltInfoSelfTutExplainArmor'):RegisterWatchLua('altInfoSelfTabExplain', function(widget, trigger)
	widget:SetVisible(trigger.armor or trigger.armorFocus)
end, false, nil, 'armor')

object:GetWidget('AltInfoSelfTutExplainMagicArmor'):RegisterWatchLua('altInfoSelfTabExplain', function(widget, trigger)
	widget:SetVisible(trigger.magicArmor or trigger.magicArmorFocus)
end, false, nil, 'magicArmor', 'magicArmorFocus')

object:GetWidget('altInfoSelfStatContainer'):SetVisible(true)
object:GetWidget('altInfoSelfDamageContainer'):SetVisible(true)

object:GetWidget('AltInfoHeroArmor'):RegisterWatchLua('altInfoSelfTabExplain', function(widget, trigger)
	widget:SetVisible(trigger.showMoreInfo or trigger.armor)
end, false, nil, 'showMoreInfo', 'armor')

object:GetWidget('AltInfoHeroMagicArmor'):RegisterWatchLua('altInfoSelfTabExplain', function(widget, trigger)
	widget:SetVisible(trigger.showMoreInfo or trigger.magicArmor)
end, false, nil, 'showMoreInfo', 'magicArmor')
...
local function altInfoSelfRegister(object)
	...
	object:GetWidget('AltInfoSelfArmorIcon_Parent'):RegisterWatchLua('AltInfoSelf', function(widget, trigger)
		local totalArmor = trigger.armor + trigger.magicArmor
	...
	end, true, nil, 'armor', 'magicArmor')	-- 'showMoreInfo'
	...
	object:GetWidget('AltInfoHeroArmor'):RegisterWatchLua('AltInfoSelf', function(widget, trigger) widget:SetText(libNumber.round(trigger.armor, 0)) end, false, nil, 'armor')

	object:GetWidget('AltInfoHeroMagicArmor'):RegisterWatchLua('AltInfoSelf', function(widget, trigger) widget:SetText(libNumber.round(trigger.magicArmor, 0)) end, false, nil, 'magicArmor')
